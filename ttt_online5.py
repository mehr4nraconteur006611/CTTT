...
def main(args):
    ...
    base_image_save_path = '/content/Pointnet_Pointnet2_pytorch/SaveImage'
    ...
    directory_to_zip = "/content/Pointnet_Pointnet2_pytorch/SaveImage"
    output_filename = "/content/Pointnet_Pointnet2_pytorch/SaveImage.zip"
