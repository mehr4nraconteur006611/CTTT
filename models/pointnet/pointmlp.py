...
from models.pointnet.models import pointnet2_utils
...
class Modelfeat(nn.Module):
    def __init__(self, points=1024, class_num=40, embed_dim=64, groups=1, res_expansion=1.0,
                 activation="relu", bias=True, use_xyz=True, normalize="center",
                 dim_expansion=[2, 2, 2, 2], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
                 k_neighbors=[32, 32, 32, 32], reducers=[2, 2, 2, 2],FPFH_type=False, **kwargs):
...
def pointMLPfeat(num_classes=40, **kwargs) -> Modelfeat:
    x = Modelfeat(points=1024, class_num=num_classes, embed_dim=64, groups=1, res_expansion=1.0,
